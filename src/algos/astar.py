...
from src.algo_functions import add_to_frontier, pop_frontier, is_visited, add_visited, get_all_possible_moves, add_heuristic_cost
from src.pancakes_fuctions import is_solved


def astar_solve(start_state: list[int], goal_state: list[int], heuristic: str = "gap") -> Optional[tuple[int, list[int], list[int]]]:
    ...
    while frontier:
        ...
        possible_moves = add_heuristic_cost(possible_moves, heuristic=heuristic)
